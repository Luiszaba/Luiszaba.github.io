...
A link to Micah Shute's article is here: [Guide To Setting Up Your Windows Linux Subsystem](http://dev.to/micahshute/setting-up-windows-subsytem-for-linux-3b7n)
